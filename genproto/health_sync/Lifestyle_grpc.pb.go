...
type LifestyleServiceClient interface {
	...
	List(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*LifestyleList, error)
}
...
func (c *lifestyleServiceClient) List(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*LifestyleList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type LifestyleServiceServer interface {
	...
	List(context.Context, *Filter) (*LifestyleList, error)
	mustEmbedUnimplementedLifestyleServiceServer()
}

// UnimplementedLifestyleServiceServer must be embedded to have
...
func (UnimplementedLifestyleServiceServer) List(context.Context, *Filter) (*LifestyleList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedLifestyleServiceServer) mustEmbedUnimplementedLifestyleServiceServer() {}
func (UnimplementedLifestyleServiceServer) testEmbeddedByValue()                          {}
...
func RegisterLifestyleServiceServer(s grpc.ServiceRegistrar, srv LifestyleServiceServer) {
	// If the following call pancis, it indicates UnimplementedLifestyleServiceServer was
...
func _LifestyleService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LifestyleServiceServer).List(ctx, req.(*Filter))
	}
	return interceptor(ctx, in, info, handler)
}
